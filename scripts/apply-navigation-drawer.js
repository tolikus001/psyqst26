...
function getDrawerHtml(currentScreen) {
  return `
  <!-- =========================================================
      ...
      <div class="drawer-content">
        ...
        <div>
          ...
          <div class="drawer-list">
            <a href="javascript:void(0);" onclick="navigateFromDrawer('02_landing_partner.html'); return false;" class="drawer-item ${currentScreen === '02_landing_partner.html' ? 'active-current' : ''}">
              ...
              ${currentScreen === '02_landing_partner.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="drawer-list">
            <!-- Урок 1 -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('03_lesson1.html'); return false;" class="drawer-item ${currentScreen === '03_lesson1.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '03_lesson1.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>

            <!-- Урок 2 -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('04_lesson2.html'); return false;" class="drawer-item ${currentScreen === '04_lesson2.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '04_lesson2.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>

            <!-- Урок 3 -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('05_lesson3.html'); return false;" class="drawer-item ${currentScreen === '05_lesson3.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '05_lesson3.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>

            <!-- Урок 4 -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('06_lesson4.html'); return false;" class="drawer-item ${currentScreen === '06_lesson4.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '06_lesson4.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>

            <!-- Урок 5 -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('07_lesson5.html'); return false;" class="drawer-item ${currentScreen === '07_lesson5.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '07_lesson5.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="drawer-list">
            <!-- Бонусы -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('09_bonuses.html'); return false;" class="drawer-item ${currentScreen === '09_bonuses.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '09_bonuses.html' ? '<span class="drawer-item-tag bonus">Вы здесь</span>' : '<span class="drawer-item-tag bonus">4 бонуса</span>'}
            </a>

            <!-- Индивидуальный разбор -->
            <a href="javascript:void(0);" onclick="navigateFromDrawer('14_individual_offer.html'); return false;" class="drawer-item ${currentScreen === '14_individual_offer.html' ? 'active-current' : ''}">
              <div class="drawer-item-left">
              ...
              ${currentScreen === '14_individual_offer.html' ? '<span class="drawer-item-tag">Вы здесь</span>' : '<span style="color:rgba(31,46,53,0.3); font-size:16px;">→</span>'}
            </a>
          </div>
        </div>
      </div>
...
// Конфигурация шапок для каждого файла
const LESSON_HEADERS = {
  '03_lesson1.html': `
      <!-- Navigation Header (Урок 1 из 5) -->
      <header class="header-bar-nav">
        ...
        <div class="header-progress-row">
          <span class="lesson-badge-sub">Урок 1 из 5</span>
          <span class="progress-percent-sub">20% пройдено</span>
        </div>

        <div class="progress-track" style="width:100%; height:5px; background:rgba(36,49,57,0.08); border-radius:999px; overflow:hidden;">
          <div style="width:20%; height:100%; background:linear-gradient(90deg, #C4734F, #45656D); border-radius:999px;"></div>
        </div>
      </header>
`,
  '04_lesson2.html': `
      <!-- Navigation Header (Урок 2 из 5) -->
      <header class="header-bar-nav">
        <div class="header-actions-row">
          <button type="button" onclick="openNavDrawer();" class="nav-glass-tinted-btn">
            <span>🧭</span>
        ...
        <div class="header-progress-row">
          <span class="lesson-badge-sub">Урок 2 из 5</span>
          <span class="progress-percent-sub">40% пройдено</span>
        </div>

        <div class="progress-track" style="width:100%; height:5px; background:rgba(36,49,57,0.08); border-radius:999px; overflow:hidden;">
          <div style="width:40%; height:100%; background:linear-gradient(90deg, #C4734F, #45656D); border-radius:999px;"></div>
        </div>
      </header>
`,
  '05_lesson3.html': `
...
`,
  '02_landing_partner.html': `
      <!-- Navigation Header -->
      <div class="header-actions-row" style="margin-bottom: 10px;">
        <button type="button" onclick="openNavDrawer();" class="nav-glass-tinted-btn">
          <span>🧭</span>
          <span>Навигация по курсу</span>
        </button>
        <button type="button" onclick="safeHaptic('selection'); openScreen('03_lesson1.html');" class="next-lesson-btn">
          <span>Начать урок 1 →</span>
        </button>
      </div>
`,
  '01_psyquest.html': `
...
// Функция встраивания стилей и шторки в файл
function processFile(filename) {
  ...
  // 1. Встраиваем CSS перед </style> если его еще нет
  if (!content.includes('NAVIGATION HEADER & DRAWER STYLES')) {
    content = content.replace('</style>', `${DRAWER_CSS}\n  </style>`);
  }

  // 2. Встраиваем HTML шторки перед </body> если ее еще нет
  if (!content.includes('id="navDrawerOverlay"')) {
    const drawerHtml = getDrawerHtml(filename);
    content = content.replace('</body>', `${drawerHtml}\n</body>`);
  }

  // 3. Обновляем шапку в зависимости от файла
  const newHeader = LESSON_HEADERS[filename];
  if (newHeader) {
    // Для уроков 1-5
    if (['03_lesson1.html', '04_lesson2.html', '05_lesson3.html', '06_lesson4.html', '07_lesson5.html'].includes(filename)) {
      content = content.replace(/<!-- Navigation & Progress Bar[\s\S]*?<\/header>/, newHeader.trim());
      // Запасной вариант если комментарий отличается
      content = content.replace(/<header class="header"[\s\S]*?<\/header>/, newHeader.trim());
    }
    // Для бонусов 09
    else if (filename === '09_bonuses.html') {
      content = content.replace(/<!-- Top Navigation -->[\s\S]*?<\/div>\s*<\/div>/, `<!-- Top Navigation -->\n${newHeader.trim()}\n      </div>`);
    }
    // Для бонусов 10, 11, 12, 13
    else if (['10_bonus1.html', '11_bonus2.html', '12_bonus3.html', '13_bonus4.html', '14_individual_offer.html'].includes(filename)) {
      // Ищем блок навигации сверху
      if (content.includes('class="top-nav-btn"')) {
        content = content.replace(/<a[^>]*class="top-nav-btn"[^>]*>[\s\S]*?<\/a>/, newHeader.trim());
      }
    }
    // Для лендингов
    else if (['02_landing_partner.html', 'index.html', '01_psyquest.html', '08_portrait_quest.html'].includes(filename)) {
      if (content.includes('<header class="header">')) {
        content = content.replace('<header class="header">', `${newHeader.trim()}\n      <header class="header">`);
      }
    }
  }
...
Object.keys(LESSON_HEADERS).forEach(file => {
  processFile(file);
});

console.log('All 15 pages successfully updated with navigation drawer & buttons!');
