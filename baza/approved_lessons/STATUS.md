# 📊 РЕЕСТР СТАТУСОВ СБОРКИ УРОКОВ (Атлант ↔ Кодер)

Этот файл автоматически обновляется при поступлении новых ТЗ от Атланта и по мере сборки экранов Кодером.

## 🟢 Сценарий 1: Существующие экраны (out/client/)

| # | Файл ТЗ | Статус | Целевой файл HTML | Endpoint API | Notibot Article ID |
|---|---|---|---|---|---|
| 01 | — | ✅ Собрано | `01_psyquest.html` | `/api/psyquest` | `35Kvp1YSxOSOzKeVKcpom2` |
| 02 | — | ✅ Собрано | `02_landing_partner.html` | NONE | `54xiZ3LlRdXnk88t9xPt7s` |
| 03 | — | ✅ Собрано | `03_lesson1.html` | `/api/lesson1-strategy` | `6QzHvAlz22e4IEb6wVhjy0` |
| 04 | — | ✅ Собрано | `04_lesson2.html` | `/api/lesson2-strategy` | `6wQPr20VEfbLD5Jg6GeEVR` |
| 05 | — | ✅ Собрано | `05_lesson3.html` | NONE | `0wFlaZghZ7ZieZiqFtJpSs` |
| 06 | — | ✅ Собрано | `06_lesson4.html` | `/api/lesson4-strategy` | `1ddMHSu3zb0ixr2CWRLKvg` |
| 07 | — | ✅ Собрано | `07_lesson5.html` | `/api/lesson5-synthesis` | `4uMyKJZW4TdZJM8z9G7Zbg` |
| 08 | — | ✅ Собрано | `08_portrait_quest.html` | `/api/portrait-assessment` | `2plu9h6VcWiAQ3TrZ8nLql` |
| 09 | — | ✅ Собрано | `09_bonuses.html` | NONE | `6ZwOzlMAERTYgkV2FsWnVx` |
| 10 | — | ✅ Собрано | `10_bonus1.html` | NONE | `5MKoAoaLdnrJqZaczYSZth` |
| 11 | — | ✅ Собрано | `11_bonus2.html` | NONE | `5DiBJPDNERZWQCXQ7C2OoX` |
| 12 | — | ✅ Собрано | `12_bonus3.html` | NONE | `38HgDSX5SePPcFWySLUMNs` |
